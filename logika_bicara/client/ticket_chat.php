...
<div>
<h2>Chat Ticket</h2>
<p class="text-soft mb-0">Percakapan support antara client dan tim.</p>
</div>
...
<a href="../uploads/ticket/<?= $ticket['attachment']; ?>" target="_blank" class="btn-dark-custom mt-2">
Download Attachment
</a>
...
<textarea name="message" class="form-control mb-3" rows="3" placeholder="Tulis pesan..." required></textarea>
