...
Monitor status, approval, dan timeline project client.
</p>
</div>
...
<td>
<a href="update_project.php?id=<?= $row['id']; ?>" class="btn-green">
Update
</a>

<a href="progress_project.php?id=<?= $row['id']; ?>" class="btn-dark-custom">
Timeline
</a>
</td>
