...
<div>
<h2>Admin Ticket Chat</h2>
<p class="text-soft mb-0">
Balas dan pantau percakapan ticket client.
</p>
</div>
...
<form action="update_status_ticket.php" method="POST" class="mb-3">

<input type="hidden" name="ticket_id" value="<?= $ticket_id; ?>">

<label class="mb-2">Ubah Status Ticket</label>

<div class="d-flex gap-2">

<select name="status" class="form-control" required>
<option value="process" <?= $ticket['status']=="process" ? "selected" : ""; ?>>
Process
</option>
...
<label class="mb-2">Balasan</label>
