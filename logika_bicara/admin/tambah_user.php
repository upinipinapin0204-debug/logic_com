...
Tambahkan akun baru untuk admin, staff, atau client.
</p>
</div>

<a href="users.php" class="btn-dark-custom">
Kembali
</a>
...
<label>Nama</label>
<input type="text" name="nama" class="form-control mb-3" placeholder="Masukkan nama user" required>

<label>Email</label>
<input type="email" name="email" class="form-control mb-3" placeholder="Masukkan email user" required>
