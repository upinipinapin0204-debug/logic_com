...
SELECT project.*, users.nama AS client_name
FROM project
...
Tambah, ubah, dan pantau project client.
</p>
</div>

<a href="tambah_project.php" class="btn-green">
+ Tambah Project
</a>
...
<a href="hapus_project.php?id=<?= $row['id']; ?>"
