...
Perbarui artikel, gambar, tanggal, dan isi konten publik.
</p>
</div>
...
<input type="text" name="judul" class="form-control mb-3" value="<?= $row['judul']; ?>" required>

<label>Tanggal</label>
<input type="date" name="tanggal" class="form-control mb-3" value="<?= $row['tanggal']; ?>" required>
...
<img src="../uploads/artikel/<?= $row['gambar']; ?>" class="current-img">
...
<textarea name="isi" class="form-control mb-4" rows="8" required><?= $row['isi']; ?></textarea>
