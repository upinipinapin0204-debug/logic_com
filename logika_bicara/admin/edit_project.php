...
Perbarui data project dan status pengerjaan.
</p>
</div>
...
<option value="waiting" <?= $row['approval_status']=="waiting" ? 'selected' : ''; ?>>
Waiting
</option>

<option value="approved" <?= $row['approval_status']=="approved" ? 'selected' : ''; ?>>
Approved
</option>
